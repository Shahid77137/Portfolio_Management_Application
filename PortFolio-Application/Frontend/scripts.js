...
function fetchAllPMData() {
    console.log("working");
    alert("working");
    fetch("http://localhost:8555/portfolio_managers")
...
function updatesubmit(){
  ...
  fetch(`http://localhost:8555/portfolio_manager/${managerId}`, {
    method: "PUT",
    headers: {
...
function fetchsinglePMData() {
  ...
  alert(id)
  fetch(`http://localhost:8555/getportfolio_managerbyId/${id}`)
    .then(response => response.json())
    .then(data => {
      const tableContainer = document.getElementById("tableContainer");
      tableContainer.innerHTML = ""; // Clear previous data
...
function fetchAllPJData() {
  console.log("working");
  alert("working");
  fetch("http://localhost:8555/Projects")
    .then(response => response.json())
    .then(data => {
      const tableContainer = document.getElementById("tableContainer");
      tableContainer.innerHTML = ""; // Clear previous data
...
function updateprojectformsubmit(){
  ...
  alert("projectId "+projectId);
  alert("formData"+formData);
  fetch(`http://localhost:8555/Updateprojects/${projectId}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json"
    },
...
function fetchsinglePJData() {
  ...
  alert(id)
  fetch(`http://localhost:8555/getProjectbyId/${id}`)
    .then(response => response.json())
    .then(data => {
      const tableContainer = document.getElementById("tableContainer");
      tableContainer.innerHTML = ""; // Clear previous data
...
function fetchAllDvpData() {
  console.log("working");
  alert("working");
  fetch("http://localhost:8555/Developer")
    .then(response => response.json())
    .then(data => {
      const tableContainer = document.getElementById("tableContainer");
      tableContainer.innerHTML = ""; // Clear previous data
...
function updatedeveloperformsubmit(){
  ...
  alert("developerId "+developerId);
  alert("formData"+formData);
  fetch(`http://localhost:8555/UpdateDeveloper/${developerId}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json"
    },
...
function submitGetDeveloperForm() {
  ...
  alert(id)
  fetch(`http://localhost:8555/getDeveloperbyId/${id}`)
    .then(response => response.json())
    .then(data => {
      const tableContainer = document.getElementById("tableContainer");
      tableContainer.innerHTML = ""; // Clear previous data
